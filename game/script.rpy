...
label day1_park:
    ...
    n "そWhich would mean, that the boy is her little brother huh?"
...
label toilet_scene:
    n "どうする…"
    n "ん!?誰かがトイレに近づいて来る足音が聞こえる。まずい、逃げよう!!"
...
label epilogue:
    ...
    n "激しく求め合った俺たち　"
    n "年齢も性格も生活環境も、全く離れ違う２人。　"
    n "おれの強引な求めにあの子は答えてくれていた。"
    n "ただオレは、あの子に甘えていただけだったんだ。"
    n "— The End —"
    return
